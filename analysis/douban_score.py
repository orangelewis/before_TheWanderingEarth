...
if __name__ == '__main__':
    ...
    for item in data.items():
        ...
        data_1["maoyan_score"] =  float(maoyan_score)
    ...
    for item in data_list:
        ...
        list3.append(item['maoyan_score'])

    attr = np.array(list1[0:10])
    v1 = np.array(list2[0:10])

    bar = Bar("2011-2018年科幻电影豆瓣评分TOP10", title_pos='center', title_top='18', width=1400, height=400)
    ...
    bar.render("2011-2018年科幻电影豆瓣评分TOP10.html")
